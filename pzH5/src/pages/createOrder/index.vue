<template>
  <div class="container">
    ...
    <van-cell-group class="cell">
      <van-cell>
        <template #title>
          <span class="server-name">就诊医院</span>
        </template>
        <template #default>
      ...
      <van-cell>
        <template #title>
          <span class="server-name">就诊时间</span>
        </template>
        <template #default>
      ...
      <van-cell>
        <template #title>
          <span class="server-name">陪诊师</span>
        </template>
        <template #default>
      ...
      <van-cell>
        <template #title>
          <span class="server-name">接送地址</span>
        </template>
        <template #default>
          <van-field
            class="text"
      ...
      <van-cell>
        <template #title>
          <span class="server-name">联系电话</span>
        </template>
        <template #default>
          <van-field
            class="text"
...
const componionConfirm = computed(() => {
